...
from parser_data_classes.line_type import LineType
...
class Line:
    ...
    boldRanges: list
    italicRanges: list
    underlinedRanges: list
    boldItalicRanges: list
    strikeoutRanges: list
    noteRanges: list
    omittedRanges: list
    escapeRanges: list
    removalSuggestionRanges: list
    _uuid: uuid.uuid4()
    ...
    def initWithString(self, string: str, type: LineType, position: int, parser: LineDelegate) -> any:
        ...
        self.boldRanges = []
        self.italicRanges = []
        self.underlinedRanges = []
        self.boldItalicRanges = []
        self.strikeoutRanges = []
        self.noteRanges = []
        self.omittedRanges = []
        self.escapeRanges = []
        self.removalSuggestionRanges = []
    ...
    def typeAsString(self, type: LineType):
        match type:
            ...
            case LineType.LineType.titlePageUnknown:
                return "Title Page Unknown"
            case LineType.LineType.heading:
                return "Heading"
            case LineType.LineType.action:
                return "Action"
            case LineType.LineType.character:
                return "Character"
            case LineType.LineType.parenthetical:
                return "Parenthetical"
            case LineType.LineType.dialogue:
                return "Dialogue"
            case LineType.dualDialogueCharacter:
                return "DD Character"
            case LineType.dualDialogueParenthetical:
...
'''
    ...
    def canBeSplitParagraph(self) -> bool: 
        return (self.type == LineType.action) or (self.type == LineType.lyrics) or (self.type == LineType.centered)
    ...
    #pragma mark - Section depth --- SHIFT RESPONSIBILITY
